...
namespace Zblog.Controllers
{
    ...
    public class CommentsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(comments.OrderByDescending(c => c.Created).ToList());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,BlogPostId,AuthorId,Body,Created,Slug,Updated,UpdateReason")] Comment comment)
        {
            if (ModelState.IsValid)
            {
